  ...
  # Dashboard web de Inventários (Projeto Smart Stock)
...
```
  ...
  Para _self-hosting_, você pode usar o arquivo [`compose.prod.yaml`](compose.prod.yaml) para subir a aplicação em produção. Além do próprio Next.js, o compose também configura um servidor Nginx.
...
Esse repositório contém a implementação do frontend do projeto, desenvolvida por **[Ruan Macedo Santos](https://github.com/msruan)**.
